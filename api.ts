...
/**
 * Returns student records, optionally filtered by search text and department.
...
export const getPatchStudentMutationOptions = <TError = ErrorType<Error>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchStudentMutationError = ErrorType<Error>
    export type PatchStudentMutationVariables = {id: number;data: BodyType<StudentUpdate>}

    /**
 * @summary Partially update a student
 */
export const usePatchStudent = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchStudent>>, TError,PatchStudentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
